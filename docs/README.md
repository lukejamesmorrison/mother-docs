...
<script setup>
  ...
  import MotherCoreAnimation from '../../components/MotherCore/MotherCoreAnimation.vue';
...
[Get Started](./MotherAutopilotSystem/README.md) | [Flight Planning](./MotherAutopilotSystem/Modules/FlightPlanningModule.md) 
<!-- | [Docking](./MotherAutopilotSystem/Modules/DockingModule.md) -->
...
Mother Core is a programmable block script framework for creating custom Space Engineers ingame scripts. It uses C#6 and deployed using [MDK2](https://github.com/malforge/mdk2/wiki). Mother Core comes with rich intergrid communication, command sharing with other scripts built with Mother Core, and a robust system for adding new modular capability to your scripts. Mother OS and MAPS are built on top of Mother Core and cooperate automatically without any additional setup from the player.
...
::: -->
 ...
 [Get Started](./Framework/README.md) | [MDK-SE API Index](https://malforge.github.io/spaceengineers/pbapi/) | [Space Engineers Mod API](https://keensoftwarehouse.github.io/SpaceEngineersModAPI/api/index.html)
...
**Malware** has made done critical foundational work by building the [MDK-SE API Index](https://malforge.github.io/spaceengineers/pbapi/) and [MDK2](https://github.com/malforge/mdk2/wiki). Without these tools, developing a framework of this complexity would not have been possible. Cheers mate 🍻 
